...
function externalConnectionProviderLabel(provider: string): string {
  return provider === "openai" ? "OpenAI Images" : provider === "cloudflare" ? "Cloudflare Workers AI" : provider === "google_tts" ? "Google TTS" : provider === "pexels" ? "Pexels" : provider === "freesound" ? "Freesound" : provider || "未选择供应商";
}
