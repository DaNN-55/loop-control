...
function MediaAdapterCard({ adapterKey, form, onChange }: { adapterKey: MediaAdapterKey; form: MediaAdapterForm; onChange: (field: keyof MediaAdapterForm, value: string) => void }) {
