...
import { defaultReviewRenderComposition, recoverFinalReviewRender, requestReviewRevision, submitStudioReviewRevision } from "./reviewRevision";
...
describe("审核修订", () => {
  ...
  it("冻结 Studio 工程后才提交合成修订", async () => {
    ...
    await submitStudioReviewRevision({ accessToken: "owner-token", episodeId: "episode-1", reviewPackageId: "review-1", reason: "调整字幕", sourceProjectRelativePath: "episodes/episode-1/review-render/v1/index.html", workspaceRelativePath: "episodes/episode-1/studio/123/index.html", composition: { aspectRatio: "9:16", width: 1080, height: 1920, captionsEnabled: true, captionStyle: "cinematic", pacing: "standard", crop: "cover", transition: "fade", layout: "lower_third", narrationGainDb: 0, bgmGainDb: -12, sfxGainDb: -6, frameRate: 30, allowedFrames: 2 } });
