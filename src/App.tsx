  ...
  return <>
    ...
    {activeSection === "blueprints" ? <div aria-labelledby="account-blueprints-heading" className="account-layout" id="account-blueprints-panel" role="tabpanel">
      <section className="blueprint-list">
        ...
        {historyBlueprints.length || archivedHistoryBlueprints.length ? <section aria-labelledby="blueprint-history-heading" className="blueprint-history"><header className="blueprint-history-heading"><h3 id="blueprint-history-heading">历史版本</h3><span>{historyBlueprints.length + archivedHistoryBlueprints.length}</span></header><div aria-label="历史版本列表" className="blueprint-history-list">
