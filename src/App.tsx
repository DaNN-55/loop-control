  ...
  return <article className={`shot-preparation-card${isOpen ? " is-open" : ""}${frozen ? " is-frozen" : ""}`}>
    ...
    {isOpen ? <div className="shot-preparation-body">
      <div className="shot-preparation-fields">
        ...
        <label className="shot-subtitle-switch"><span><strong>显示字幕</strong><small>字幕样式在 Studio 调整</small></span><input checked={subtitlesEnabled} disabled={frozen} onChange={(event) => setSubtitlesEnabled(event.target.checked)} role="switch" type="checkbox" /></label>
      </div>
