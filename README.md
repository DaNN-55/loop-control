...
**面向 Owner 的短视频生产控制台，把配置、生产、审核、QC 和最终交付包放在一条可追溯流程里。**

<img src="assets/banner.png" alt="Loop Control 的视频生产与审核流程封面" width="100%">

## 项目作用

Loop Control 管理多账号短视频生产。每条生产单会冻结账号蓝图、素材边界和执行路径，由本机 Worker 处理任务，Owner 在控制台审核结果，并在最终交付包校验通过后完成生产。
